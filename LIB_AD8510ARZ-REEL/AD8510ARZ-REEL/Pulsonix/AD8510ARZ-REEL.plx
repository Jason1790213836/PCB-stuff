...
//882674/1798179/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD8510ARZ-REEL" (originalName "AD8510ARZ-REEL")
	...
	(compDef "AD8510ARZ-REEL" (originalName "AD8510ARZ-REEL") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "NULL_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "NULL_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD8510ARZ-REEL"))
		...
		(attr "Mouser Part Number" "584-AD8510ARZ-R")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD8510ARZ-REEL?qs=%2FtpEQrCGXCwXL7drMaFeVQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD8510ARZ-REEL")
		(attr "Description" "Precision, Very Low Noise, Low Input Bias Current, Wide Bandwidth JFET Single Operational Amplifier")
		(attr "<Hyperlink>" "https://www.analog.com/AD8510/datasheet")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "AD8510ARZ-REEL.stp")
