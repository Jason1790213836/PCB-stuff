SamacSys ECAD Model
3078/1798179/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADG884BRMZ" (originalName "ADG884BRMZ")
	...
	(compDef "ADG884BRMZ" (originalName "ADG884BRMZ") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "D1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "IN1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "S1B") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "S2A") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "D2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "IN2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "S2B") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "GND") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADG884BRMZ"))
		...
		(attr "Mouser Part Number" "584-ADG884BRMZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADG884BRMZ?qs=BpaRKvA4VqHGAEKiRnJ1Qg%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "ADG884BRMZ")
		(attr "Description" "ADG884BRMZ, Analogue SPDT Switch Dual SPDT, 3, 5V, 10-Pin, MSOP")
		(attr "Datasheet Link" "http://www.analog.com/static/imported-files/data_sheets/ADG884.pdf")
		(attr "Height" "1.1 mm")
	)
