...
(library Library_1
	...
	(compDef "ADG884BRMZ" (originalName "ADG884BRMZ") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "S1B") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "S2A") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "D2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "IN2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "S2B") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.analog.com/static/imported-files/data_sheets/ADG884.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "ADG884BRMZ.stp")
