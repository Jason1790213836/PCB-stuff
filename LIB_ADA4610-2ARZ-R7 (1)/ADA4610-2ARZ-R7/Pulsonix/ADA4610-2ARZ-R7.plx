...
//993147/1798179/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADA4610-2ARZ-R7" (originalName "ADA4610-2ARZ-R7")
	...
	(compDef "ADA4610-2ARZ-R7" (originalName "ADA4610-2ARZ-R7") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADA4610-2ARZ-R7"))
		...
		(attr "Mouser Part Number" "584-ADA4610-2ARZ-R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADA4610-2ARZ-R7?qs=BpaRKvA4VqEBfMREioRxEg%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "ADA4610-2ARZ-R7")
		(attr "Description" "Low Noise, Precision, Rail-to-Rail Output, JFET Dual Op Amp +/-5 V to +/-15 V 40C to +125C")
		(attr "<Hyperlink>" "https://www.analog.com/ADA4610-2/datasheet")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ADA4610-2ARZ-R7.stp")
