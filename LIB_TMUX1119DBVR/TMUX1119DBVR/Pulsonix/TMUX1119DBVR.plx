...
(library Library_1
	...
	(compDef "TMUX1119DBVR" (originalName "TMUX1119DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "S2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/TMUX1119")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TMUX1119DBVR.stp")
