SamacSys ECAD Model
12229073/1798179/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TMUX1119DBVR" (originalName "TMUX1119DBVR")
	...
	(compDef "TMUX1119DBVR" (originalName "TMUX1119DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "S2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "D") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "S1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TMUX1119DBVR"))
		...
		(attr "Mouser Part Number" "595-TMUX1119DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TMUX1119DBVR?qs=9r4v7xj2Lnn%2FqYCDWCSZ7w%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TMUX1119DBVR")
		(attr "Description" "Analog Switch ICs 3-pA, 5-V, 2:1 (SPDT), 1-channel precision multiplexer")
		(attr "Datasheet Link" "https://www.ti.com/lit/gpn/TMUX1119")
		(attr "Height" "1.45 mm")
	)
