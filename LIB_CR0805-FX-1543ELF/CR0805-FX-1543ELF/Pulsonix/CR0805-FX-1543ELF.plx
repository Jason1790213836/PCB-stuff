...
//13775310/1798179/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "CR0805-FX-1543ELF" (originalName "CR0805-FX-1543ELF")
	...
	(compDef "CR0805-FX-1543ELF" (originalName "CR0805-FX-1543ELF") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CR0805-FX-1543ELF"))
		...
		(attr "Mouser Part Number" "652-CR0805FX-1543ELF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Bourns/CR0805-FX-1543ELF?qs=Hqdsf0hGw%2FDRTThedSiXGA%3D%3D")
		(attr "Manufacturer_Name" "Bourns")
		(attr "Manufacturer_Part_Number" "CR0805-FX-1543ELF")
		(attr "Description" "Thick Film Resistors - SMD 154K 1%")
		(attr "<Hyperlink>" "https://www.bourns.com/pdfs/chpreztr.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "CR0805-FX-1543ELF.stp")
